...
<script type="module">
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyBGu763Fek8Oz4sv0DDTeYOArJOf7h73pg",
    authDomain: "foonate-49d4d.firebaseapp.com",
    projectId: "foonate-49d4d",
    storageBucket: "foonate-49d4d.firebasestorage.app",
    messagingSenderId: "228884334058",
    appId: "1:228884334058:web:daa5d6f48eb94049b6de93",
    measurementId: "G-ZM4VD7ZMV1"
  };
    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="main-menu__top-inner">
                        ...
                        <div class="main-menu__top-btn">
                            <a href="signin/signup.php"> <span></span> Signup Now</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="main-menu__wrapper-inner">
                            ...
                            <div class="main-menu__right">
                                ...
                                <div class="main-menu__btn-box">
                                    <a href="donate/donate-payment.php" class="main-menu__btn thm-btn"><span>Donate
                                            Now</span></a>
                                </div>
                            </div>
                        </div>
        ...
        <section class="main-slider">
            ...
            <div class="main-slider__carousel owl-carousel owl-theme">
                    ...
                    <div class="container">
                        <div class="main-slider__content">
                            <div class="main-slider__sub-title-box">
                                ...
                                <h5 class="main-slider__sub-title">Always donate for children's</h5>
                            </div>
                            <h2 class="main-slider__title">Charity is an act <br> of Tender heart</h2>
                            <p class="main-slider__text">Charity is an act of a tender heart, reflecting kindness,
                                empathy, <br>
                                and the desire to make a positive impact.</p>
                            <div class="main-slider__btn-box">
                                <a href="contact.html" class="main-slider__btn thm-btn"><span>Join with Us</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item">
                    <div class="main-slider__bg"
                        style="background-image: url(assets/images/backgrounds/slider-1-4.jpg);">
                    </div>
                    <div class="main-slider__map"
                        style="background-image: url(assets/images/shapes/main-slider-map.png);"></div>
                    <div class="container">
        ...
        <section class="services-one">
            ...
            <div class="container">
                <div class="section-title text-center sec-title-animation animation-style1">
                    ...
                    <h2 class="section-title__title title-animation">Empowering Communities Through
                        <br> Compassionate Action</h2>
                </div>
                <div class="row">
                            ...
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <div class="services-one__content-inner">
                                        ...
                                        <h3 class="services-one__title"><a href="service-details.html">Food Assistance
                                                Programs</a></h3>
                                        <p class="services-one__text">Providing nutritious meals and essential
                            ...
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <div class="services-one__content-inner">
                                        ...
                                        <h3 class="services-one__title"><a href="service-details.html">Holistic Support
                                                Programs</a></h3>
                                        <p class="services-one__text">Providing nutritious meals and essential
                                            groceries to individuals and families
                                            facing food insecurity.</p>
                            ...
                            <div class="services-one__img-box">
                                ...
                                <div class="services-one__content">
                                    <div class="services-one__content-inner">
                                        ...
                                        <h3 class="services-one__title"><a href="service-details.html">Driven Compassion
                                                Programs</a></h3>
                                        <p class="services-one__text">Providing nutritious meals and essential
                                            groceries to individuals and families
                                            facing food insecurity.</p>
                ...
                <!-- <div class="services-one__video">
                    <div class="services-one__video-img">
                        <img src="assets/images/services/services-one-video-img.jpg" alt="">
                    ...
                    <div class="services-one__audio-box">
                        ...
                        <div class="services-one__audio-title-box">
                            <h4>Youth Mentorship and Development</h4>
                        </div>
                    </div>
                </div> -->
            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="about-one__single">
                                        ...
                                        <h3 class="about-one__title"><a href="about.html">Driven Compassion</a></h3>
                                    ...
                                    <div class="about-one__single">
                                        ...
                                        <h3 class="about-one__title"><a href="about.html">Sustainable Impact</a></h3>
                                        <p class="about-one__text">Every service we offer is rooted
                                            compassion aiming to make</p>
                                        <div class="about-one__read-more">
                                            <span></span>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    ...
                                    <div class="about-one__single">
                                        ...
                                        <h3 class="about-one__title"><a href="about.html">Holistic Support</a></h3>
                                        <p class="about-one__text">Every service we offer is rooted
                                            compassion aiming to make</p>
                                        <div class="about-one__read-more">
                                            <span></span>
